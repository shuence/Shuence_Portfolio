...
// changes bg
const MoneyTexture = new THREE.TextureLoader().load('/img/Money.jpg')
scene.background = MoneyTexture;

// avatar

const aniTexture = new THREE.TextureLoader().load('img/ani.png')
...
const imageTexture = new THREE.TextureLoader().load('img/normal.jpg')
